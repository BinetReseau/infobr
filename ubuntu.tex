...
est \textit{eleves.polytechnique.fr}, tu peux aussi ajouter \textit{polytechnique.fr} pour acc\'eder plus facilement aux machines des salles info. Choisi un nom de machine
(en g\'en\'eral ton pseudo) que tu reporteras dans qRezix pour qu'il soit enregistr\'e.
\imagepos{images/kubuntu_config_reseau0}{0.55}{Configuration du r\'eseau sous Kubuntu}{!ht}
...
Une fois ta configuration r\'eseau est termin\'ee, tu peux la tester en \emph{pinguant} \fkz (dans une console), o\`u tu devrais voir quelque chose comme :
...
\textbf{NB:} on peut aussi le faire depuis \app{synaptic} (ubuntu) ou \app{adept} (kubuntu), il suffit d'aller dans le menu faisant r\'ef\'erence aux d\'ep\^ots

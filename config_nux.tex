...
Là, tu choisis l'option \menu{Oui}, puis tu valides et tu as normalement un message qui t'annonce que ta configuration r\'eseau est termin\'ee.
...
Dans l'utilitaire \app{drakconf}, choisis l'onglet \menu{Gestionnaire de logiciels}, puis clique sur \menu{ajouter la source personalis\'ee}, \`a choisir \menu{Serveur FTP} et à mettre comme url \url{ftp://miroir/mandriva}.

...
\imagepos{images/nux_proxy_firefox}{0.60}{Configuration du proxy sous Firefox}{ht}
...
\imagepos{images/nux_config_kmail_pop}{0.66}{Configuration de la r\'eception des messages sous Kmail}{pht}

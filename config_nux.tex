...
\begin{description}
  ...
  \item [l'IP de ta passerelle (\emph{gateway})] not\'ee \server{129.104.GGG.CCC}
        \textcolor{red}{(attention, pour Foch, Fayolle et Maunoury ce n'est pas n\'ecessairement vrai que $GGG = AAA$)}.
...
5050 pour qRezix, ...) dans ton firewall pour pouvoir pleinement profiter du r\'eseau
...
La configuration est semblable, n'importe quel client tu utilises.

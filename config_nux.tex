...
Le BR poss\`ede son propre miroir Mandriva, que nous te conseillons d'utiliser,
ceux-ci \'etant beaucoup plus rapide que les miroirs ext\'erieurs.
Dans l'utilitaire \app{drakconf}, choisis l'onglet \menu{Gestionnaire de logiciels},
puis clique sur \menu{ajouter la source personalis\'ee}, \`a choisir \menu{Serveur FTP}
et à mettre comme url \url{ftp://miroir/mandriva}.

...
conna\^itre ton adresse IP, l'adresse IP de ta passerelle (\emph{gateway}), ton masque de sous-r\'eseau et ton adresse de diffusion (\emph{broadcast}).
Toutes les informations n\'ecessaires se trouvent page
\pageref{calcul_ip}.

Bien s\^ur, l'ensemble des manipulations d\'ecrites ci-dessous doit se faire en tant que \emph{root}!
...
{(elle est dr\^ole celle-l\`a  hein ?)}
...
\urllink{http://frankiz.polytechnique.fr/proxy.pac}.

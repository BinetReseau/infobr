...
\begin{itemize}
  \item Ton seul interlocuteur valable est la K\`es, tu ne dois pas demander \`a ton commandant de promotion
...
la K\`es. Il est imp\'eratif de les soumettre par l'interface pr\'evue pour cela sur \fkz.
...
Pour continuer \`a communiquer avec les personnes int\'eress\'ees, utilise le forum de ton binet
(\ngname{br.binet.ton\_binet}) et les mails (en cr\'eant \'eventuellement une liste de diffusion).

...
\begin{itemize}
  ...
  \item des services d'hébergement pour les groupes et binets, notamment des noms de domaine (\emph{via} \server{www.po\-ly\-tech\-ni\-que.net}) et des listes de diffusion (\mail{br2008@po\-ly\-tech\-ni\-que.org} par exemple).
\end{itemize}

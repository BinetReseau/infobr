...
\begin{itemize}
  ...
  \item des services d'hébergement pour les groupes et binets, notamment des noms de domaine (\emph{via} \server{www.polytechnique.net}) et des listes de diffusion (comme par exemple \mail{br@2013.polytechnique.org}).
\end{itemize}

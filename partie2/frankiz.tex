...
conseillons de faire de \urllink{http://www.frankiz.net/} la page d'accueil de ton navigateur Internet.
...
la question du jour (\menu{QDJ}). Tu peux accéder à ces services sous forme de mini-modules que tu peux d\'eplacer sur ta page d'accueil pour adopter la configuration que tu préfères. Tout est ais\'ement personnalisable (lien \lien{Administration}). \`A toi d'explorer tout ce que tu peux y trouver !
...
M%\emph{Ton binet organise une activité sur le plateau} (ex : Spectacle,

...
un sommaire et disparaissent une fois que tu les as lues. Tu peux également en mettre certaines en favorites pour ne garder que celles qui t'intéressent. Les activités sont listées sur la page dédiée et apparaissent
...
Même si \fkz est l'œuvre de tous, les webmestres se réservent le droit de ne pas publier une annonce ou d'interdire un site web si le contenu
n'est pas jugé adapté mais aussi, dans le cas des annonces, si elle gêne la lisibilité générale, selon le bon principe~: \og~trop
d'information tue l'information~\fg .
...
\begin{itemize}
 \item ne doit pas être trop longue (pas plus d'une quinzaine de lignes)~;
 \item doit être écrite dans un français correct~: pas de langage sms, pas de faute d'orthographe~;
 \item doit être écrite avec une typographie correcte~: pas de majuscule ou de point d'exclamation partout, particulièrement dans le titre~;

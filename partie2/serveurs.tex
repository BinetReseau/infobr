...
\begin{description}
        ...
        \item[sil] (\server{129.104.247.3}) : ancien proxy ssh double sens, proxy ftp, il va bient\^ot \^etre d\'esafect\'e donc ne t'inqui\`etes pas si tu ne peux plus t'y connecter, mais contact un BRman pour savoir comment faire autrement. 

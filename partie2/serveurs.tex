...
\begin{description}
        ...
        \item[poly] (\server{129.104.247.5}) : mails (r\'eception et envoi), tu trouveras en t'y connectant en http (\url{http://poly/}) le certificat de s\'ecurit\'e pour l'authentification s\'ecuris\'ee.

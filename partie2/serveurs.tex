...
\begin{description}
        ...
        \item[sil] (\server{129.104.247.3}) : ancien proxy ssh double sens, proxy ftp, il va bient\^ot \^etre d\'esactiv\'e donc ne t'inqui\`ete pas si tu ne peux plus t'y connecter ; contacte un BRman ou va voir sur le WikiBR pour savoir comment faire autrement. 

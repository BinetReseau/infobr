...
\begin{description}
    ...
    \item[koun] (\server{129.104.201.1})~: MSDNAA (logiciels Microsoft gratuits)
    \item[Lodan] (\server{129.104.201.54})~: D\'epot SVN (plus d'infos sur le WikiX)
\end {description}
...
\begin{description}
        \item[kuzh] (\server{129.104.247.2})~: \emph{proxy} http (pour l'Internet), \emph{proxy} ssh pour sortir du plateau.

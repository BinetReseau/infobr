...
\begin{description}
        ...
        \item[poly] (\server{129.104.247.5}) : mails (réception, envoi), tu trouveras en t'y connectant en http (\urllink{http://poly/}) le certificat de sécurité pour l'authentification sécurisée.

...
\begin{description}
        ...
        SVN, t\'el\'e
<<<<<<< .mine
        \item[lunedenn] (\server{129.104.201.56}) : Wifi
...
\begin{description}
        \item[milou] (\server{129.104.30.41}) : DNS polytechnique.fr, NTP
        \item[rackham] (\server{129.104.32.41}) : DNS polytechnique.fr
...
abus risque d'\^etre sanctionn\'e par la DSI et pourra entra\^iner la perte de tes comptes
poly, moned ou sil}
=======
stockage. Seul sil est pr\'evu pour du transfert de fichiers. La DSI est assez vigilante,
et elle a pour habitude de sanctionner les abus; cela peut include la parte de tes comptes

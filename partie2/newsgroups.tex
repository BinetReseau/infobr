...
\begin{itemize}
 ...
 \item L'usurpation d'identité est interdite et sera sanctionnée par un bannissement des brs. Nous rappelons aux utilisateurs qu'il est possible de savoir depuis quelle adresse IP un message a été posté. Poster depuis un ordinateur de binet ou de bar section est ainsi fortement déconseillé (sauf sur les \ngname{br.binet.*} ou \ngname{br.section.*} correspondants, mais mettre son nom en fin de message reste conseillé et poli);

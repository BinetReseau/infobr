...
\emph{PodCast}, à l'adresse \urllink{http://tv.eleves.polytechnique.fr/tvbr.xml}. Sous \app{vlc}, active la découverte des services \emph{PodCast} dans la liste de

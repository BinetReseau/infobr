...
Parmi les plus simples on trouve \app{FileZilla Server} et \app{GuildFTP}, qui sont libres de surcro\^{i}t. Pour les d\'etails de l'installation, rendez-vous sur le WikiX : \urllink{http://wikix.polytechnique.org/FTP}.

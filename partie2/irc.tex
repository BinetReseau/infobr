...
\begin{description}
  ...
  \item[passer par l'interface web:] utilises \url{http://ircserver/}, ou suis le lien \menu{Accéder à IRC} sur \fkz. Tu pourras ainsi profiter d'IRC sans rien avoir à installer.
\end{description}

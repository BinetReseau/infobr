...
\hrule width0pt height0pt depth0pt \vskip 5truecm \vfill
\begin{center}
    { \Huge InfoBR 2k6 }

    \vskip 1truecm

    { \LARGE Binet Réseau 2k5 }
\end{center}
\vskip 15truecm \vfill

\ThisCenterWallPaper{0.75}{images/logo_br}

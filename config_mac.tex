...
Un conseil : pense \`a activer le blocage des fenêtres pop-up (dans le menu \menu{Safari}). Tu peux aussi utiliser \app{Firefox} si tu pr\'ef\`eres !

\subsubsection{Configuration mail}

\flimage{images/mac_mail_icone}{0.1}{l}
\app{Mail} : un client mail, offrant les fonctionnalit\'es classiques d'un bon client : filtre antispam, r\`egles de tri automatique des mails, regroupement des mails correspondant \`a une même discussion.

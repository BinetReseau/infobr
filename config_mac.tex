  ...
  \begin{figure*}[!h]
    \begin{center}  
     ...
     % \hfill
      ...
      \fbox{\includegraphics[width=0.98\textwidth]{images/mac_nouvelle_config_leopard_1}}\\ \vspace*{2cm}
      \fbox{\includegraphics[width=0.98\textwidth]{images/mac_nouvelle_config_leopard_2}} 
 		\end{minipage}
 		 } 		
 		\subfloat[Configuration de l'interface réseau \emph{ethernet}, de l'adresse IP et du \emph{proxy}]{ 
 		 \begin{minipage}{0.49 \textwidth}\centering
 		\fbox{\includegraphics[width=0.98 \textwidth]{images/mac_config_ethernet}} \\ 
 		\fbox{\includegraphics[width=0.98 \textwidth]{images/mac_config_ip_leopard}} \\
 		\fbox{\includegraphics[width=0.98 \textwidth]{images/mac_config_proxy_leopard}}
 		\end{minipage}
...
\emph{proxies} manuellement, et mettre \server{kuzh.poly\-tech\-nique.fr}, port \server{8080}.
...
%\imagepos{images/mac_config_proxy_leopard}{0.4}{Configurer le \emph{proxy}}{hl!}
...
Dans l'onglet \menu{Airport}, choisir comme réseau \menu{kastell} puis dans l'onglet \menu{Avancé}, choisir \menu{802.1W} et saisir votre login poly (seulement 8 caractères max) et votre mot de passe \server{Frankiz}. Ne pas oublier de cocher la case TTLS comme dans la capture.

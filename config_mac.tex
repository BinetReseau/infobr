...
Pour configurer le Wifi au Bataclan, télécharge d'abord  le certificat sur \urllink{http://wifi/certificats.html}.
...
\flimage{images/mac_mail_icone}{0.07}{l} \app{Mail} : un client mail offrant les fonctionnalités classiques d'un bon client : recherche instantanée, filtre antispam, règles de tri automatique des mails, regroupement des mails correspondant à une même discussion.

...
Pourquoi ? Parce que pour faire une blague subtile que vous comprendrez quand vous serez grands, la page 11 portait le numéro 37 et la page 37 le numéro 11. Avec cette interversion, les numéros de page sont dans l'ordre mais plus le texte\ldots\ Bref, vous allez vous en sortir, mais faites attention à ne pas sauter une partie de la configuration !

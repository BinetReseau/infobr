...
N'oublie pas d'ouvrir les ports qui vont bien (21 pour un serveur ftp, 5050 pourqRezix, ...) dans ton firewall pour
pouvoir pleinement profiter du r\'eseau.
...
Clique ensuite sur l'onglet \menu{mandataire} à droite, coche la case
\menu{Nom du serveur mandataire} et inscrit dans le champ correspondant :
\url{kuzh:8080}, puis valide. Clique ensuite sur \menu{ajouter} pour
...
du 2. seront inutiles et tu auras juste à cliquer sur \menu{ajouter la source
personalis\'ee}, \`a choisir serveur ftp et à mettre comme url \url{ftp://miroir/mandriva}.

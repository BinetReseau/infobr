...
(\server{129.104.AAA.CCC}) et l'adresse de \emph{broadcast} (\server{129.104.\linebreak{}AAA.EEE}). Le masque de sous-r\'eseau est toujours
...
\noindent \begin{tabular}{p{\ecart}<{\dotfill}@{}l}
  Sous-r\'eseau (\server{AAA}) & {\ungaramond 203} pour le bâtiment A ; {\ungaramond 204} au bâtiment D \\
...
\begin{center}
  ...
  \hline
  \rule[-8pt]{0pt}{24pt} \textbf{Mon IP :} \ungaramond 129.104. & \\ \hline
  \rule[-8pt]{0pt}{24pt} \textbf{Ma passerelle :} \ungaramond 129.104. & \\ \hline
  \rule[-8pt]{0pt}{24pt} \textbf{Mon \emph{broadcast} :} \ungaramond 129.104. & \\ \hline

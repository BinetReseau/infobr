...
\subsubsection{En Joffre}
Les identifiants \server{AAA} et \server{BBB} se calculent \`a partir de ton num\'ero de casert. \server{BBB} correspond aux deux derniers chiffres. Par exemple, pour le casert $12.10.61$, \server{BBB} $= 61$. \server{AAA} et les autres adresses n\'ecessaires \`a la configuration sont indiqu\'ees dans le tableau ci-dessous :
\\
\begin{center}
\begin{tabular}{|>{\ungaramond}c|>{\ungaramond}c|c|c|c|}
\hline \multirow{2}{*}{\'Etage} & \multirow{2}{*}{AAA} & \multirow{2}{*}{\bf Passerelle} & \bf Adresse de  & \bf Masque de  \\ 
 & & & \bf{diffusion} & \bf sous-r\'eseau \\
\hline 10 & 216 & \multirow{4}{*}{\server{129.104.219.254}} & \multirow{4}{*}{\server{129.104.219.255}} & \multirow{4}{*}{\server{255.255.252.0}} \\ 
\cline{1-2} 20 & 217 &  &  &  \\ 
\cline{1-2} 30 & 218 &  &  &  \\ 
\cline{1-2} 40 & 219 &  &  &  \\ 
\hline

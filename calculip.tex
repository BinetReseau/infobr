...
cela implique des conflits r\'eseau qui font que les deux perdent
l'acc\`es tant que cela n'est pas corrig\'e.
...
\noalign{\vrule}
&  \bf Masque de &\omit& \bf sous-r\'eseau&& \multispan{23} \vsep\vfil\hbox{\quad 255.255.252.0\quad}\vfil\vsep&\cr
}\vrule} \hfil

\vskip 6pt

\exemple{l'IP associ\'ee \`a la prise $A145$ est \server{129.104.209.165} ($165 = 120 + 45$) ; sa passerelle est \server{129.104.211.254}, son adresse de
\emph{broadcast} est \server{129.104.211.255} et son masque de sous-r\'eseau est \server{255.255.252.0}.}
...
(\server{129.104.AAA.CCC}) et l'adresse de \emph{broadcast} (\server{129.104.AAA.EEE}). Le masque de sous-r\'eseau est toujours
...
\exemple{l'IP associ\'ee \`a la prise $70 30 30$ est \server{129.104.224.158} ($158 = 128 + 30$) ; sa passerelle est \server{129.104.224.254}, son
adresse de \emph{broadcast} est \server{129.104.224.255} et son masque de sous-r\'eseau est \server{255.255.255.128}.}

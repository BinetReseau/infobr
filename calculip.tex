...
\begin{itemize}
\item $zz$ sert \`a trouver les identifiants \server{BBB} par la r\`egle : $BBB = 120 + zz$.

\item $xx$ sert \`a trouver ton sous-r\'eseau (\server{AAA}), ta passerelle,
ton adresse de \textit{broadcast} et ton masque r\'eseau, selon le tableau suivant.
\end{itemize}
...
\exemple{l'IP associ\'ee \`a la prise $70 40 30$ est \server{129.104.224.158} ($158 = 128 + 30$) ;
...
\begin{itemize}
 \item Sous-r\'eseau (\server{AAA}): 203 pour le b\^atiment A ; 204 au b\^atiment D,
 \item Passerelle : \server{129.104.AAA.13},
 \item Masque de sous-r\'eseau : \server{255.255.255.0},
 \item Broadcast : \server{129.104.AAA.255}.
 \item IP (\server{BBB}) : 50 + les deux derniers chiffres du num\'ero de ta chambre.
\end{itemize}

\subsubsection{Le PEM}

\begin{itemize}
 \item Sous-r\'eseau (\server{AAA}): 214,
 \item Passerelle : \server{129.104.214.13},
 \item Masque de sous-r\'eseau : \server{255.255.255.0},
 \item Broadcast : \server{129.104.214.255},
 \item IP (\server{BBB})
 \begin{itemize}
  \item au rez-de-chauss\'ee : 15 + les deux derniers chiffres du num\'ero de ta chambre;
  \item au premier \'etage : 70 + les deux derniers chiffres du num\'ero de ta chambre.
 \end{itemize}
\end{itemize}

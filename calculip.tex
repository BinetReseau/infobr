...
$xx$ sert \`a trouver ton sous-r\'eseau ($AAA$), ta passerelle (\emph{gateway}),
...
$zz$ sert \`a trouver les identifiants $BBB$ par la r\`egle : $BBB = 120 + zz$.

\emph{Exemple :} l'IP associ\'ee \`a la prise $A145$ est $129.104.209.165$ ($165 = 120 + 45$) ;
sa passerelle (Gateway) est $129.104.211.254$, son \textit{broadcast} est $129.104.211.255$
et son masque r\'eseau (Netmask) est $255.255.252.0$.
...
les IP's de la passerelle et du broadcast sont de la forme $129.104.AAA.DDD$ et $129.104.AAA.EEE$.
...
Le masque de sous-r\'eseau est toujours $255.255.255.128$,
le broadcast est toujours $129.104.AAA.127$.

\subsubsection{Le BEM}
Si tu habites au b\^atiment A, $AAA = 203$, au b\^atiment D, $AAA = 204$.
Ta passerelle est $129.104.AAA.13$, le masque de sous-r\'eseau est $255.255.255.0$,
le broadcast est $129.104.AAA.255$.

Pour $BBB$, c'est simple : $BBB = 50 + \mbox{le num\'ero de ta chambre}$.

\subsubsection{Le PEM}
Ici, $AAA = 214$, la passerelle est $129.104.214.13$,
le broadcast est $129.104.214.255$ et le masque r\'eseau est $255.255.255.0$.

...
\noindent\begin{tabular}{l@{\xleaders\copy\point\ecart}l}
  ...
  IP (\server{BBB}) au rez-de-chaussée & 15 + les deux derniers chiffres du numéro de ta chambre \\
  IP (\server{BBB}) au premier étage   & 70 + les deux derniers chiffres du numéro de ta chambre \\

...
On prend $xx$ pour calculer ton sous-r\'eseau, l'adresse de ta passerelle (\server{129.104.AAA.DDD})
...
\begin{tabular}{l@{\xleaders\copy\point\ecart}l}
  ...
  Passerelle                             & \server{129.104.214.13} \\
  Masque de sous-r\'eseau                & \server{255.255.255.0} \\
  Broadcast                              & \server{129.104.214.255} \\
\end{tabular}

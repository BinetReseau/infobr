...
\exemple{l'adresse IP associ\'ee \`a la prise $C145$ est \server{129.104.213.165} ($165 = 120 + 45$) ; sa passerelle est \server{129.104.215.254}, son adresse de
diffusion est \server{129.104.215.255} et son masque de sous-r\'eseau est \server{255.255.252.0}.}

\subsubsection{En Foch et Joffre}

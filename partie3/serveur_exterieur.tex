...
Lorsque tu as la flemme de taper sshExt ou que tu veux utiliser git il faut rajouter deux lignes dans \file{/home/user/.ssh/config}, par exemple pour toujours passer par le \proxy{proxy} lorsque tu te connectes à \server{github.com} :

...
Lorsque tu as la flemme de taper sshExt ou que tu veux utiliser git il faut rajouter deux lignes dans \file{/home/user/.ssh/config}, par exemple pour toujours passer par le proxy lorsque tu te connectes à \server{github.com} :
...
Ensuite tu devras configurer ton logiciel de mail pour qu'il se connecte à \server{127.0.0.1} sur le port 6663.

...
Pour ouvrir une ligne de commande à distance tu vas devoir utiliser \app{Putty} sur \urllink{http://www.putty.org/}, ensuite pour te connecter à un serveur ouvre \app{Putty} et tape le nom du serveur puis sur \menu{Open}. Une console s'ouvrira et te demandera ton utilisateur et mot de passe puis tu auas accès aux fichiers sur le serveur distant.

...
\mbr{Eracil/Ronan}{61 58}{\wins}{InfoBR, support@windows}{Ce responsable de la propagande du Binet R\'eseau est atypique, en effet bien que windowsien dans les faits, on le voit souvent se promener avec un Manchot sur lui, r\'eponds rapidement \`a tes demandes pourvu que sont emploi du temps ne soit pas d\'ej\`a plein. Si tu reçois une réponse à pas d'heure ne t'inquiètes pas c'est qu'il a \emph{encore} un travail important à faire ou une activité qui a fini très tard.}

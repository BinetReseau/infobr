\subsection{Membres éminents du Binet R\'eseau}
...
\mbr{Eracil/Ronan}{61 58}{\wins}{InfoBR, support@windows}{Ce responsable de la propagande du Binet R\'eseau est atypique, en effet bien que windowsien dans les faits, on le voit souvent se promener avec un Manchot sur lui, r\'eponds rapidement \`a tes demandes pourvu que sont emploi du temps ne soit pas déj\`a plein.}
...
\mbr{Claire}{65 16}{\wins}{News, BRwoman}{Arrivée au BR par accident, pour elle l'info c'est java. Son ordinateur, elle ne l'utilise que pour des applications simples: la preuve, elle est sous vista. Dort entre 22h et 7h m\^eme les week-end.}

\mbr{Pauline}{60 33}{\wins}{Tol, web, BRwoman}{Respo je ne connais rien a l'informatique mais je suis au BR. Toujours dispo pour corriger vos annonces, valider vos activités et admirer vos photos tol. Bref, je ne sais pas répondre \`a vos questions, mais je le ferai toujours avec le sourire. On m'a dit que la BRwoman ne sert qu'\`a ça de toute façon.}
...
des relations bien plac\'ees.}
  ...
  \item[TV]{Charg\'es de maintenir la diffusion de la t\'el\'e sur le r\'eseau. Changeurs de chaîne, dieux du multicast, ils sont les amis des switches\dots\ ou pas.}

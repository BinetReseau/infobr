...
\begin{itemize}
  ...
  \item des services d'hébergement pour les groupes et binets, notemment des noms de domaine (via \server{www.po\-ly\-tech\-ni\-que.net}) et des listes de diffusion (\mail{br2005@po\-ly\-tech\-ni\-que.org}, par exemple).
\end{itemize}
...
Par ailleurs, nos filtres antivirus et antispam sont très efficaces (99\%), nous te conseillons donc de mettre en place la redirection
suivantes : \mail{prenom.nom@polytechnique.edu} redirigée sur \mail{prenom.nom(.promo)@po\-ly\-tech\-ni\-que.org}, elle-même redirigée vers
\mail{login@poly(.po\-ly\-tech\-ni\-que.fr)}. Pour effectuer ces redirections, connecte-toi sur les pages suivantes :
\begin{itemize}
  \item pour \mail{@polytechnique.edu} : \urllink{https://www.mail.polytechnique.edu} ;
  \item pour \mail{@polytechnique.org} : \urllink{https://www.polytechnique.org} (elle est drôle celle-là, hein ?) ;
...
En cas de problème, relatif ou non à celà, n'hésite pas à contacter
\mail{contact@po\-ly\-tech\-ni\-que.org}.

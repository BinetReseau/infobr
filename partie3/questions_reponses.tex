...
\item[J'ai perdu mon mot de passe qRezix] je le re-définis dans mes  \menu{Préférences} sur \fkz : \urllink{http://frankiz/\-profil/reseau.php}.

\item[Je veux voir mon pseudo quand j'ai voté à la QDJ] je définis mon pseudo sur ma fiche \linebreak trombino sur la page \urllink{http://frankiz/profil/profil.php} (lien \menu{Préférences}).

...
%  \item[Résolution DNS] trouver l'IP associée à un nom DNS pour pouvoir se connecter à la machine concernée.
  ...
  \item[Wiki*] De Wikipaedia, terme d\'esignant la plus c\'el\`ebre des encycop\'edies libres en ligne, \'editables par tous. Par extension d\'esigne tous site construit sur ce mod\`ele, par exemple WikiX et WikiBR (enfin le BR ne te permet pas de tout \'editer sur ces pages).
\end{description}

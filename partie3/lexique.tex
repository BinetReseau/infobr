...
\begin{description}
  ...
  \item[FAQ] (Foire Aux Questions, ou \emph{Frequently Asked Questions}) c'est là que tu peux trouver des réponses classiques ou même quelques trucs et astuces
...
%  \item[Résolution DNS] trouver l'IP associée à un nom DNS pour pouvoir se connecter à la machine concernée.
  \item[RTF*] \emph{Read The Fucking}\ * : allusion sympathique au fait que tu aurais pu trouver l'information autre part\ldots\ tout près souvent (voir RTFIBR, RTFFAQ, RTFM, etc.)

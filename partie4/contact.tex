...
\item[\mail{web@frankiz.net}] Pour contacter les personnes qui valident les annonces et activités sur \fkz, créent des groupes et des comptes.
...
\item[\mail{hebergement@eleves}] Pour obtenir un hébergement via le BR si tu n'as pas déjà de groupe/binet frankiz.

...
\begin{description}
  ...
  \item[Client] (voir serveur) : programme qui permet de se connecter à un serveur. Par exemple un client \emph{news} (comme \app{Thunderbird}) ou un client FTP (comme \app{SmartFTP})

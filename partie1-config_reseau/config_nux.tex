...
Une dernière chose spécifique à Debian, pour pouvoir utiliser \app{apt-get} et \app{apt-cache} à travers le proxy de l'école, il faut rajouter la ligne ci-dessous dans \file{/etc/apt/apt.conf} :
...
où \texttt{[flavour]} est la saveur de ta debian: \texttt{stable}, \texttt{testing}, \texttt{unstable} ou \texttt{experimental}.

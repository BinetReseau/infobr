...
\file{/etc/hostname} avec ton éditeur préféré (\app{vi} ou \app{vim}, \app{pico}, voire \app{emacs} si tu aimes), mais la commande ci-dessous est suffisante:
...
\image{partie1-config_reseau/nux_config_kmail_pop}{0.65}{Configuration de la réception des messages sous Kmail}
...
\image{partie1-config_reseau/nux_config_kmail_smtp}{0.65}{Configuration de l'envoi des messages sous Kmail}
...
Sous \app{Knode}, c'est dans le menu \menu{Configuration}, puis \menu{Configurer Knode}. Va dans la rubrique \menu{Comptes, Forums de discussion} et clique sur \menu{Nouveau...}
...
\image{partie1-config_reseau/nux_knode}{1.0}{Knode}

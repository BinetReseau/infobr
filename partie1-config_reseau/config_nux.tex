...
Enfin, le fichier \file{/etc/conf.d/net} contient la description de l'interface réseau et les informations de routage. Il indique ton IP, ton sous-réseau, et la passerelle pour sortir de ton sous-réseau :
...
\cmdline{64 bytes from frankiz (129.104.201.51): icmp\_seq=2 ttl=63\\ time=0.269 ms}
...
deb ftp://miroir/debian-non-US [flavour]/non-US main contrib non-free\\
deb ftp://miroir/debian-security [flavour]/updates main contrib non-free\\

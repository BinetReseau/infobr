...
GENTOO_MIRRORS="ftp://miroir/gentoo http://gentoo.osuosl.org/"\\
SYNC="rsync://rsync/gentoo-portage"}

Tu peux évidemment ajouter d'autres miroirs dans ta liste (en les séparant par les espaces)... mais ftp://miroir étant interne il sera toujours beaucoup plus rapide que les autres. On te conseille ici http://gentoo.osuosl.org/ qui est un miroir très complet (mais très lent).

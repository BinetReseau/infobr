...
Le BR maintient par ailleurs un miroir debian : tu peux l'utiliser en rajoutant à ton \file{/etc/sources.list} les lignes suivantes, où \texttt{[flavour]} est la saveur de ta debian, à choisir parmi  \texttt{stable}, \texttt{testing}, \texttt{unstable} ou \texttt{experimental} (seulement \texttt{stable} ou \texttt{testing} pour \texttt{debian-security}).

...
soit 32 bits, donc tu peux commencer à essayer avec la version 32 bits.
...
\noindent{\footnotesize Pour des raisons historiques, cette page porte le numéro 31. L'explication se trouve en page 11.} \vfill \pagebreak
...
On remarque aussi que parfois, même sur un processeur 64 bits il vaut mieux
choisir la version 32 bits de Windows (celle qui est dans le prochain item)
dû à la disponibilité de drivers.
...
\noindent \cmdline{
C:$\backslash$Windows$\backslash$system32>netsh\\
netsh>winhttp\\
netsh winhttp>set proxy proxy-server="http://kuzh:8080"\\
netsh winhttp>exit\\
C:$\backslash$Windows$\backslash$system32>exit}

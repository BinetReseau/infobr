...
Soit tu choisis de configurer toi-même ton ordinateur, et tu peux passer directement à la section SECTION INSTALL ANTI-VIRUS. Tu trouveras les informations nécessaires à la confiration manuelle du pare-feu et du proxy pour \app{Windows Update} sur le WikiBR, à l'article $ARTICLE_QUI_VA_BIEN$.
...
On te rappelle que tu ne peux t'inscrire sur le domaine que si tu utilise Windows 2000, Windows XP Pro ou Windows Vista. Si tu possède Windows XP Familial, Windows Vista Home ou encore une version antérieure de Windows, tu dois effectuer toi-même tes réglages de pare-feu et de proxy \app{Windows Update}. Réfère-toi pour cela à l'article $ARTICLE_QUI_VA_BIEN$ sur le WikiBR.
...
essaie d'utiliser un pseudo qui t'identifie de façon claire et unique, par exemple \guillemotleft $NOM_PRENOM$ \guillemotright  \footnote{Les Jean
...
\begin{itemize}
\item en version 32 bits : \url{ftp://enez/antivirus/Win32\_ Vista.zip}.
\item en version 64 bits : \url{ftp://enez/antivirus/Win64\_ Vista.zip}.
\end{itemize}

\item Si tu as Windows XP ou une autre version de Windows\dots
\begin{itemize}
\item en version 32 bits : \url{ftp://enez/antivirus/Win32\_ PasVista.zip}.
\item en version 64 bits : \url{ftp://enez/antivirus/Win64\_ PasVista.zip}.
\end{itemize}
\end{itemize}

Une fois téléchargé le fichier adéquat, tu ouvres l'archive compressée \file{Win??\_ *.zip}, tu décompresses \emph{tous les fichiers} dans un dossier, et enfin tu exécutes le fichier \file{setup.exe} qui vient d'apparaitre dans ce dossier. A partir de là, tu n'as plus qu'à suivre les instructions du programme d'installation. Alors, tu n'auras plus à toucher à l'antivirus, celui-ci sera mis à jour automatiquement.
...
\url{ftp://enez/msdnaa/win\_ xp/french/win\_ xp\_ pro\_ sp2\_ fr.iso}.
...
\url{ftp://enez/msdnaa/win\_ vista/dvd\_ 64bits/french/vista\_ dvd\_ x64\_ fr.iso}. Attention, cette images iso est à graver sur un DVD.
\item[Si tu as un processeur 32 bits :] Là, tu peux choisir de graver :
\begin{itemize}
\item soit un DVD : \\
\url{ftp://enez/msdnaa/win\_ vista/dvd\_ 32bits/french/vista\_ dvd\_ x86\_ fr.iso}.
\item soit quatre CDs (!) : \\
\url{ftp://enez/msdnaa/win\_ vista/cd\_ 32bits/french/vista\_ cd\( N\) \_ x86\_ fr.iso}, N variant de 1 à 4.

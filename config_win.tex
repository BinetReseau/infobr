...
Tes paramètres (en particulier tes favoris) seront directement importés depuis \app{Internet Explorer}, la seule configuration à effectuer étant le
proxy. Pour cela, clique sur \menu{Options} dans le menu \menu{Outils} puis sur \menu{Paramètres de connexion} en bas à droite. La case à cocher est

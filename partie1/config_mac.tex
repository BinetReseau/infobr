...
La configuration est détaillée pour Mac OS 10.8 (\app{Mountain Lion}), elle est sensiblement identique sur Mac OS 10.9 (\app{Mavericks}),  Mac OS 10.7 (\app{Lion}), Mac OS 10.6 (\app{Snow Leopard}) et Mac OS 10.5 (\app{Leopard}).
Afin de connaître la version que tu utilises, va dans le \menu{menu Pomme} puis sélectionne \menu{ÀA propos de ce Mac}.
